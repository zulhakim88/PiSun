...
* Can it compute circumference using PI bigger than 15 decimal points? **ABSOLUTELY!**. Just use the manual calculation button that generates PI with the increase of precision by 1.
